...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!dashboard_valid_csrf()) {
        ...
        if ($action === 'save_home') {
            ...
            if (!$errors && dashboard_save_data($data)) {
                dashboard_set_flash('success', 'Portfolio berhasil disimpan dan otomatis diurutkan berdasarkan visitor.');
